...
// WiFi Credentials
char ssid[] = "Keshav";      // Your WiFi SSID
char pass[] = "11111111";  // Your WiFi Password

// IFTTT Credentials
const char* host = "maker.ifttt.com";
const int port = 80;
const String eventName = "sketch_received";
const String iftttKey = "KDTwJpdH5ybiEgfJ156VdtQmwJFrI9J4RSElAao575";

// Light Sensor Threshold
const float lightThreshold = 400.0; // Adjust as needed
